...
3.  **Generate Configuration Updates**: It generates specific configuration updates for the various agent and system files, such as:
    ...
    *   **Accessibility Audit Command Injection**: Extracts the recommended accessibility audit command from the research and injects it into the `task-execution.md` workflow.
